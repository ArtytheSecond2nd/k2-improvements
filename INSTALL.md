...
| [Stock nozzle camera stream](./installer/extras/nozzle-camera/README.md) | Streams the factory K2 Plus nozzle/AI camera in Fluidd with a 10-minute automatic shutoff. |
