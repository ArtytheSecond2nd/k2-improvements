#!/usr/bin/env python3
"""Place the Bed_Assist editor in Fluidd's Chamber Heating category."""
...
CATEGORY_NAME = "Chamber Heating"
CATEGORY_ID = str(uuid.uuid5(
    uuid.NAMESPACE_URL,
    "https://github.com/Rcpilot33/k2-improvements/fluidd/chamber-heating",
))
MACRO_NAME = "BED_ASSIST"
MACRO_ALIAS = "Bed_Assist"
MACRO_COLOR = "#FF9800"
...
def main():
    try:
        ...
        print("E: could not configure Fluidd Chamber Heating category: %s" % exc)
        return 1
    message = "configured Bed_Assist in 'Chamber Heating'" if changed else "Fluidd Bed_Assist metadata is already configured"
    print("I: %s" % message)
    return 0
